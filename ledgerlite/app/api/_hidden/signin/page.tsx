        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 lg:flex-row lg:items-center">
          ...
          <section className="w-full max-w-xl rounded-4xl bg-white p-8 shadow-2xl   lg:w-1/2 lg:p-10">
            ...
            <form className="space-y-5" onSubmit={handleSubmit} noValidate>
              ...
              <div className="flex  gap-20 sm:flex-row sm:items-center sm:justify-between">
                <label className="inline-flex items-center gap-2 md:text-sm text-xs text-slate-600 ">
                  <input
                    type="checkbox"
                ...
                <button
                  type="button"
                  className="md:text-sm text-xs font-medium text-[#0B7A75] transition hover:text-slate-900 "
                >
                  Forgot password?
                </button>
              </div>
